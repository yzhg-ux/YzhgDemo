...
import com.yzhg.tool.BuildConfig;
...
public class BaseWebViewActivity extends BaseWebActivity {
    ...
    public void setContentView(int layoutResID) {
        ...
        tvTitle = findViewById(R.id.TvWebView);
        backToolbar = findViewById(R.id.tv_back_toolbar);
        ...
        backToolbar.setOnClickListener(v -> finish());
    }

    //设置标题
    protected void setTitle(String title) {
        if (title == null || title.isEmpty()) {
            tvTitle.setText("浏览网页");
        } else {
...
//                super.onReceivedSslError(view, handler, error);
    ...
    private void openFile() {
        //申请权限
        requestPermission(permission_CAMERA_READ_WRITE_EXTERNAL_STORAGE, PermissionTools.CAMERA, PermissionTools.READ_EXTERNAL_STORAGE, PermissionTools.WRITE_EXTERNAL_STORAGE);

    }

    private void openCamera() {
        //申请权限
        requestPermission(permission_CAMERA, PermissionTools.CAMERA, PermissionTools.READ_EXTERNAL_STORAGE, PermissionTools.WRITE_EXTERNAL_STORAGE);
    }

    private void openImage() {
        //申请权限
        requestPermission(permission_IMAGE, PermissionTools.CAMERA, PermissionTools.READ_EXTERNAL_STORAGE, PermissionTools.WRITE_EXTERNAL_STORAGE);
    }

    private void openVideo() {
        //申请权限
        requestPermission(permission_VIDEO, PermissionTools.CAMERA, PermissionTools.READ_EXTERNAL_STORAGE, PermissionTools.WRITE_EXTERNAL_STORAGE);

    }

    private void openAudio() {
        //申请权限
        requestPermission(permission_AUDIO, PermissionTools.RECORD_AUDIO, PermissionTools.READ_EXTERNAL_STORAGE, PermissionTools.WRITE_EXTERNAL_STORAGE);
    }
